...

{
    ...
    'depends': ['account_accountant', 'document',
                'hr', 'web', 'website',],
    'data': [
        'class_information/ir.model.access.csv',
        'class_information/class_information_view.xml',
        'account_invoice/account_invoice_view.xml',
        'security/op_security.xml',
        'op_announcement/op_announcement_view.xml',
        ...
        'op_course_register/course_register_view.xml',
